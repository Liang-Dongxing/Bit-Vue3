    ...
    <el-collapse accordion>
      <el-collapse-item title="v1.0.0 - 2022-10-30">
        <ol>
          <li>重构若依的动态菜单</li>
          <li>重构若依顶部标签</li>
          <li>布局配置全局添加暗黑模式、主题颜色、显示水印、水印内容</li>
          <li>布局配置系统布局配置添加隐藏面包屑、显示动态标题、隐藏LOGO</li>
          <li>布局配置侧边菜单添加侧边菜单开启、侧边菜单宽度（px）、是否只展开一个子菜单、侧边菜单折叠</li>
          <li>布局配置顶部菜单添加顶部菜单、顶部菜单独占一行、顶部菜单</li>
          <li>顶部标签页鼠标右键事件重新构建</li>
          <li>其他细节优化</li>
        </ol>
      </el-collapse-item>
    </el-collapse>
